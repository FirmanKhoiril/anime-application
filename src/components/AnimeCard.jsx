...
const AnimeCard = ({ anime }) => {
  return (
    <Card sx={{ width: { md: "290px", xs: "290px", sm: "100%" } }} className="rounded-xl md:ml-16 sm:ml-20 xs:ml-10 ml-5   shadow-lg shadow-black/70 hover:scale-[1.01] hover:ease-in transition duration-700">
