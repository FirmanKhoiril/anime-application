...
const Homepage = () => {
  ...
  return (
    <div className="h-full relative -mt-[64px] md:-mt-[72px]">
      <div className="flex items-center justify-evenly md:justify-around md:flex-row flex-col bg-black/40 h-screen text-white">
        ...
        <div className="absolute top-32 md:top-[450px] md:left-40">
        ...
        <div className="flex flex-col md:mt-0 mt-40 md:right-56 absolute ">
